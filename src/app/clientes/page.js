...
const ESTADOS = {
  'Codigo entregado': { color: '#059669', bgcolor: '#f0fdf4' }, // Verde
  'Codigo no entregado': { color: '#d97706', bgcolor: '#fffbeb' }, // Amarillo oscuro
  'Promesa de pago': { color: '#2563eb', bgcolor: '#eff6ff' }, // Azul
  'Duda resuelta': { color: '#16a34a', bgcolor: '#f0fdf4' }, // Verde claro
  'Duda no resuelta': { color: '#dc2626', bgcolor: '#fef2f2' }, // Rojo
};

const ESTADOS_ASESOR = {
  'Promesa de pago': { color: '#059669', bgcolor: '#f0fdf4' },
  'Duda resuelta': { color: '#16a34a', bgcolor: '#f0fdf4' },
  'Codigo entregado': { color: '#2563eb', bgcolor: '#eff6ff' },
};
